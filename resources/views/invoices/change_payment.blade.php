...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تغيير حاله دفع الفاتوره</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            <form action="{{ route('status_update', ['id' => $invoice->id]) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" value="{{$invoice->invoice_number}}" id="invoice_number" name="invoice_number" readonly>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control fc-datepicker" id="invoice_date" name="invoice_date" value="{{$invoice->invoice_date}}"
                                               placeholder="YYYY-MM-DD" type="date"  readonly>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="amount_collect" name="amount_collect"
                                               value="{{$invoice->amount_collect}}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="commission" name="commission"
                                               value="{{$invoice->commission}}" readonly>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="rate_vat" id="rate_vat" class="form-control" onchange="myFunction()" disabled="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label for="invoice_date" class="control-label">تاريخ الفاتورة</label>
                                        <input class="form-control fc-datepicker" id="payment_date" name="payment_date" value="{{ $invoice->getUser->payment_date }}"
