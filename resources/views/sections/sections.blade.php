                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            @can('اضافه قسم')
                                <a class="modal-effect btn btn-success" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8"><i class="mdi mdi-plus"></i> اضافة قسم </a>
                            @endcan
                                ...
                                <table class="table text-md-nowrap" id="example1">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">اضافه بواسطه</th>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('sections.store') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="section_name" name="section_name" value="{{old('section_name')}}" placeholder="Section Name Here!">
                                    </div>
